        ...
        children: [
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Get noticed for the right jobs by adding your skills',
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 10),
                        Text('Suggested Skills', style: TextStyle(color: Colors.grey[600], fontSize: 14)),
                        const SizedBox(height: 10),
                        Wrap(
                          spacing: 15,
                          runSpacing: 4,
          ...
          Positioned(
            ...
            child: AnimatedBuilder(
              ...
              child: Image.asset(
                'assets/page4.png', // Replace with your image path
